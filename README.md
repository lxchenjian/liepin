...
视频：1-2 手机短信验证码一键注册登录流程阐述（05:17）

视频：1-3 详述用户表设计（05:59）

视频：1-4 申请腾讯云短信与秘钥配置（07:10）

视频：1-5 SpringBoot 集成腾讯云短信（13:14）

视频：1-6 快速构建授权中心（09:24）

视频：1-7 整合Redis并存储验证码（13:55）

视频：1-8 Redis锁机制限制ip发短信（06:24）

视频：1-9 使用拦截器限制60秒短信发送（13:04）

视频：1-10 封装优雅异常降低代码侵入性（12:36）

视频：1-11 Postman&ApiPost与Apifox 规范化接口文档与对接（08:39）

视频：1-12 使用Hibernate-Validate进行参数校验（17:32）

视频：1-13 用户一键注册登录（32:22）

视频：1-14 分布式会话RedisToken（13:33）

视频：1-15 作业：RedisToken接口认证（02:18）
